...
- **Account identity moved into the account menu.** All seven formats now live under the profile menu at the top right, where the account itself is, instead of a separate settings section. Click a row to copy it; **Copy all** and **Open profile** sit underneath.
